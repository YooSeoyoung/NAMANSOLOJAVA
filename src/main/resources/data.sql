...
INSERT INTO recommend_place (name, address, description, latitude, longitude, category_name)
VALUES ('부산호텔1', '부산 해운대구', '부산 호텔 추천 설명', 35.1587, 129.1604, '호텔');
...
INSERT INTO board (add_time, content, count_dislike, count_like, is_active, modified_time, title, user_name)
VALUES (NOW(), '커플 여행 후기 공유합니다.', 0, 10, true, NOW(), '여행 후기', 'couple2');
